    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            <div class="panel panel-default">
                ...
                <form id="userInfoForm" class="form-horizontal" action="/basicInfo_save" method="post"
                      style="width: 700px;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <label style="width: 250px;"
                                   class="form-control">${(userinfo.phoneNumber)!''}</label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" id="educationBackground"
                                    name="educationBackground.id" style="width: 180px" autocomplate="off">

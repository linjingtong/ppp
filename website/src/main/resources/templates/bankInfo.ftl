					...
					<div class="panel panel-default">
						...
						<form class="form-horizontal" id="bankForm" method="post" action="/bankInfo_save.do" novalidate="novalidate">
							<fieldset>
						        ...
						        <div class="form-group">
						        	<label class="col-sm-4  control-label" for="bankforname">支行名称</label>
					        		<div class="col-sm-8">
						        		<input id="idNumber" class="form-control" name="bankForName"  type="text" value="">
						        	</div>
						        </div>
						        <div class="form-group">
						        	<label class="col-sm-4  control-label" for="bankNumber">银行账号</label>
					        		<div class="col-sm-8">

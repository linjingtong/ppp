...
<script type="text/javascript">
	$(function() {
		...
		$(".auditClass").click(function(){
			...
			$("#image_big").attr("href",json.image);
			$("#myModal").modal("show");
		});
	});
</script>
	...
	<div class="container">
		...
		<div id="userfile_dialog" >
		      	<form class="form-horizontal" id="editform" method="post" action="/userFile_audit.do">
			        	...
			        	<div class="col-sm-6">
                            <a id="image_big" class="pic" href="#" data-fancybox-group="gallery">
			        			<img src="" id="image" style="width::200px;height: 180px"/>
							</a>
			        	</div>
			        	</div>
			        	<div class="form-group">
				...
				<div style="margin-top: 35px;margin-left: 255px" >
